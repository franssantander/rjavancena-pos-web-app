...
class InventoryProductRestockImageModel extends Model
{
    use HasFactory;
    use SoftDeletes;
    protected $table = 'inventory_product_restock_image_tbl';

    protected $primaryKey = 'id';
    protected $fillable = [
        'inventory_product_restock_image_id',
    ...
    {
        return [
            'inventory_product_restock_image_id' => 'inventory_product_restock_image_id-',
        ];
    }
    ...
    {
        $prefix = 'inventory/product/restock/image/';

        $payload = [
            'update' => ['inventory_product_restock_image_id', 'inventory_product_restock_id', 'image', 'eu_device'],
            'delete' => ['inventory_product_restock_image_id', 'inventory_product_restock_id', 'eu_device'],
        ];
        $method = [
            'update' => 'POST',
            'delete' => 'DELETE',
    ...
    {
        $prefix = 'inventory/product/restock/';
        $payload = [
            'store' => ['inventory_product_restock_id', 'image', 'eu_device']
        ];
