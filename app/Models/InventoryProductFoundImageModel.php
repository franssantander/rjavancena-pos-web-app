...
class InventoryProductFoundImageModel extends Model
{
    use HasFactory;
    use SoftDeletes;
    protected $table = 'inventory_product_found_image_tbl';

    protected $primaryKey = 'id';
    protected $fillable = [
        'inventory_product_found_image_id',
    ...
    {
        return [
            'inventory_product_found_image_id' => 'inventory_product_found_image_id-',
        ];
    }
    ...
    {
        $prefix = 'inventory/product/found/image/';

        $payload = [
            'update' => ['inventory_product_found_image_id', 'inventory_product_found_id', 'image', 'eu_device'],
            'delete' => ['inventory_product_found_image_id', 'inventory_product_found_id', 'eu_device'],
        ];
        $method = [
            'update' => 'POST',
            'delete' => 'DELETE',
    ...
    public function getApiRelativeSettings()
    {
        ...
        $payload = [
            'store' => ['inventory_product_found_id', 'image', 'eu_device']
        ];
