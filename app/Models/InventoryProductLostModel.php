...
class InventoryProductLostModel extends Model
{
    use HasFactory;
    use SoftDeletes;
    protected $table = 'inventory_product_lost_tbl';
    ...
    {
        return [
            'inventory_product_lost_id' => 'inventory_product_lost_id-',
        ];
    }
    ...
    public function getApiCrudSettings()
    {
        ...
        $payload = [
            // 'view' => ['inventory_product_lost_id'],
            // 'store' => ['inventory_product_id', 'image', 'eu_device'],
            'update' => ['inventory_product_lost_id', 'inventory_product_id',  'count', 'remarks', 'eu_device'],
            'delete' => ['inventory_product_lost_id', 'inventory_product_id', 'eu_device'],
        ];
        $method = [
            // 'view' => 'GET',
            // 'store' => 'POST',
    ...
    public function arrFieldsViewCustom(): array
    {
        return [
            'url' => 'inventory/product/lost/image/update',
            'payload' => ['inventory_product_lost_image_id', 'inventory_product_lost_id'],
            'inventory_product_lost_image_id' => null,
            'image' => null,
        ];
    }
