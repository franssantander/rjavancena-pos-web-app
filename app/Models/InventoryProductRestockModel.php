...
class InventoryProductRestockModel extends Model
{
    use HasFactory;
    use SoftDeletes;
    protected $table = 'inventory_product_restock_tbl';
    ...
    {
        return [
            'inventory_product_restock_id' => 'inventory_product_restock_id-',
        ];
    }
    ...
    public function getApiCrudSettings()
    {
        ...
        $payload = [
            // 'view' => ['inventory_product_restock_id'],
            // 'store' => ['inventory_product_id', 'image', 'eu_device'],
            'update' => ['inventory_product_restock_id', 'inventory_product_id',  'count', 'remarks', 'eu_device'],
            'delete' => ['inventory_product_restock_id', 'inventory_product_id', 'eu_device'],
        ];
        $method = [
            // 'view' => 'GET',
            // 'store' => "POST",
