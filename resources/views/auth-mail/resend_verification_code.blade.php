...
<body>
    <main
        style="font-family: Segoe UI; width: 500px; margin: auto auto; padding: 56px; box-shadow: 0 4px 4px 0 rgba(233, 240, 243, 0.4); border: 1px solid #ECEFF3; border-radius: 12px;">
        ...
        <p style="font-weight: 400; font-size: 16px;">Here is your new verification code: </p>
        ...
        <footer style="display:flex; width:100%; justify-content:space-between">
            <div >
                <div>
